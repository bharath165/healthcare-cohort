...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function () {
      ...
      _createClass(AppService, [{
        ...
        value: function getGridData(gridCount, searchText) {
          return this.http.get(this.rootURL + "/drugInfo/".concat(gridCount, "?searchText=").concat(searchText));
        }
      }, {
        key: "getGridDataLive",
    ...
    function () {
      ...
      _createClass(CohortBuilderComponent, [{
            ...
            if (this.inclusionCriteria.length !== 0) {
              for (var index = 1; index < this.inclusionCriteria.length; index++) {
                if (this.inclusionCriteria[index].id === this.inclusionCriteria[0].id) {
                  ...
                  this.inclusionCriteria.splice(0, 1); //  this.selectedIncCriterias = this.inclusionCriteria;
        ...
        value: function diseaseStateGenerate(type, i) {
          ...
          if (va === "asthma" || va === "astma" || va === "astmma" || va === "asthma") {
            va = "astma";
          ...
          if (va === "diabetics" || va === "diabetic" || va === "diabeteic" || va === "diabetes type 2" || va === "type 2 diabetes" || va === "diabetes" || va === "diabetestype2" || va === "type2diabetes") {
            va = "diabetic";
        ...
        value: function addCohort(i) {
          ...
          this.add = i + 1; // if (this.inclusionCriteria.length !== 0) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\HealthCareAnalyticsProject\healthcare-analytics-main\my-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
