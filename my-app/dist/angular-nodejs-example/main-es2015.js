...
class AppService {
    ...
    getGridData(gridCount, searchText) {
        ...
        if (gridCount == 1) {
            return this.http.get("http://127.0.0.1:5000/HealthAPIv2/ICD10v2/" + `${searchText}`);
        }
        else if (gridCount == 2) {
            return this.http.get("http://127.0.0.1:5000/HealthAPIv2/ConceptIDs/" + `${searchText}`);
        }
        else if (gridCount == 3) {
            return this.http.get("http://127.0.0.1:5000/HealthAPIv2/ICD10v2/" + `${searchText}`);
        }
        else if (gridCount == 4) {
            return this.http.get("http://127.0.0.1:5000/HealthAPIv2/NDCs/" + `${searchText}`);
        }
    }
...
module.exports = __webpack_require__(/*! C:\Users\yrao\OneDrive - Merative\Desktop\ust cohort builder\healthcare\HealthCareAnalytics-20-05-2022-main\my-app\src\main.ts */"./src/main.ts");
